...
- Pull every value from [STANDARDS.md](STANDARDS.md) — never approximate from memory. [AUDIT.md](AUDIT.md) says what to hunt for; the standards say what the fix is.
